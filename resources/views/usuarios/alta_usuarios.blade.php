...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            ...
            <p class="text-muted">Registre nuevo personal</p>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // NUEVO: Delegación de eventos para limpiar errores al escribir
        form.addEventListener('input', function(e) {
            // Si el elemento modificado tiene la clase de error...
            if (e.target.classList.contains('is-invalid')) {
                // 1. Le quitamos el borde rojo
                e.target.classList.remove('is-invalid');

                // 2. Buscamos su div de error correspondiente y lo vaciamos
