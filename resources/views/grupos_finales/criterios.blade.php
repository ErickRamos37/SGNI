    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="mb-4">
                ...
                <p class="text-dark small mb-0">Configure los criterios para la asignación de grupos finales del primer semestre</p>
            </div>
            ...
            <div class="card border-0 shadow-sm rounded-3 bg-white mb-4">
                <div class="card-body p-4 p-md-5">
                    ...
                    <p class="text-dark small mb-4">
                        Defina el balance porcentual para la distribucion de alumnos en cada grupo. El sistema segmentara a los estudiantes basándose en su puntaje de ingreso (900 a 1300 puntos). La suma de ambos lados debe dar exactamente 100%.
                    </p>

                    {{-- Formulario de criterios estructurado en paralelo (lado a lado) --}}
                    <form action="#" method="POST" id="form-criterios">
                        @csrf
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="p-4 rounded-3 bg-light border border-light-subtle">
                                    ...
                                    <label for="porcentaje-alto" class="form-label text-uppercase fw-bold text-dark small d-block mb-3">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="p-4 rounded-3 bg-light border border-light-subtle">
                                    {{-- Ajustado a text-dark --}}
                                    <label for="porcentaje-bajo" class="form-label text-uppercase fw-bold text-dark small d-block mb-3">
...
<script type="module">
    $(document).ready(function() {
        const inputAlto = $('#porcentaje-alto');
        const inputBajo = $('#porcentaje-bajo');

        {{-- Evento cuando el docente modifica el porcentaje alto --}}
        inputAlto.on('input', function() {
            let valorAlto = parseInt($(this).val());

            if (isNaN(valorAlto)) return;

            {{-- Restringe que no pase de 99 ni baje de 1 para evitar ceros --}}
            if (valorAlto > 99) { valorAlto = 99; $(this).val(99); }
            if (valorAlto < 1) { valorAlto = 1; $(this).val(1); }

            {{-- Aplica el calculo espejo inmediato al lado contrario --}}
            inputBajo.val(100 - valorAlto);
        });

        {{-- Evento cuando el docente modifica el porcentaje bajo --}}
        inputBajo.on('input', function() {
            let valorBajo = parseInt($(this).val());

            if (isNaN(valorBajo)) return;

            if (valorBajo > 99) { valorBajo = 99; $(this).val(99); }
            if (valorBajo < 1) { valorBajo = 1; $(this).val(1); }

            {{-- Aplica el calculo espejo inmediato al lado contrario --}}
            inputAlto.val(100 - valorBajo);
        });
    });
</script>
@endsection
