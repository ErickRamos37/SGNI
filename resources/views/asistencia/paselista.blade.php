...
<div class="container-fluid py-2">
    ...
    <div class="mb-4">
        ...
        <a href="{{ route('asistencias.importar') }}" class="btn btn-primary text-white fw-bold px-4 py-2 mt-2 shadow-sm rounded-3 border-0">
            <i class="bi bi-file-earmark-excel me-2"></i> IMPORTAR LISTA EXCEL
        </a>
    </div>
    ...
    <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
                ...
                <table class="table align-middle mb-0">
                    ...
                    <tbody class="border-top-0">
                        <tr>
                            ...
                            <td class="text-center"><input class="form-check-input fs-4 shadow-sm" type="checkbox" checked style="background-color: #e9ecef; border-color: #ced4da;"></td>
                            <td class="text-center"><input class="form-check-input fs-4 shadow-sm" type="checkbox" checked style="background-color: #e9ecef; border-color: #ced4da;"></td>
                            <td class="text-center"><input class="form-check-input fs-4 shadow-sm" type="checkbox" checked style="background-color: #e9ecef; border-color: #ced4da;"></td>
                            <td class="text-center"><input class="form-check-input fs-4 shadow-sm" type="checkbox" checked style="background-color: #e9ecef; border-color: #ced4da;"></td>
                            <td class="text-center"><input class="form-check-input fs-4 shadow-sm" type="checkbox" checked style="background-color: #e9ecef; border-color: #ced4da;"></td>
        ...
        <div class="card-footer bg-white border-top py-4 px-4 d-flex justify-content-between align-items-center">
            ...
            <button class="btn btn-warning text-dark fw-bold px-5 py-2 rounded-3 shadow-sm border-0">
                GUARDAR
            </button>
        </div>
    </div>
